    ...
    if (headerEl) {
      ...
      if (best) {
        if (best.tagName === 'SVG') {
          ...
          // broken HTML and produce a "wrong logo" in the prototype. If the
          // SVG is unreasonably huge (rare; usually <8KB even for logos with
          // many paths), skip the inline copy and fall back to the URL/text.
          const svgHtml = best.outerHTML;
