...
const KEYWORDS = [
  ...
  { topic: 'technology',    terms: ['tech', 'software', 'app', 'startup', 'silicon', 'apple', 'google', 'microsoft', 'meta', 'iphone', 'android'] },
  { topic: 'finance',       terms: ['stock', 'market', 'wall street', 'invest', 'bank', 'savings', 'mortgage', 'interest rate', 'crypto', 'bitcoin'] },
  { topic: 'business',      terms: ['business', 'ceo', 'company', 'revenue', 'earnings', 'merger', 'acquisition', 'ipo'] },
  { topic: 'politics',      terms: ['election', 'president', 'congress', 'senate', 'minister', 'parliament', 'policy', 'vote', 'campaign', 'government'] },
  { topic: 'sports',        terms: ['sport', 'football', 'soccer', 'basketball', 'baseball', 'nfl', 'nba', 'fifa', 'olympic', 'championship', 'match', 'game'] },
  { topic: 'health',        terms: ['health', 'medical', 'doctor', 'hospital', 'covid', 'vaccine', 'cancer', 'diabetes', 'wellness', 'nutrition'] },
  { topic: 'science',       terms: ['science', 'researcher', 'study', 'nasa', 'space', 'climate', 'biology', 'physics'] },
  { topic: 'travel',        terms: ['travel', 'flight', 'airport', 'hotel', 'vacation', 'tourism', 'destination', 'beach', 'mountain'] },
  { topic: 'food',          terms: ['food', 'recipe', 'restaurant', 'chef', 'cooking', 'meal', 'dinner'] },
  { topic: 'entertainment', terms: ['movie', 'film', 'tv', 'streaming', 'netflix', 'music', 'album', 'concert', 'oscar', 'grammy', 'celebrity'] },
  { topic: 'automotive',    terms: ['car', 'vehicle', 'tesla', 'ev', 'electric', 'driving', 'ford', 'toyota'] },
  { topic: 'realestate',    terms: ['home', 'house', 'real estate', 'property', 'apartment', 'rent'] },
  { topic: 'fashion',       terms: ['fashion', 'style', 'designer', 'runway', 'collection'] },
  { topic: 'weather',       terms: ['weather', 'storm', 'hurricane', 'snow', 'forecast', 'climate'] },
  { topic: 'lifestyle',     terms: ['lifestyle', 'home', 'family', 'parent', 'tip', 'guide'] },
...
const CATEGORY_TO_TOPIC = {
  ...
  travel: 'travel', food: 'food', lifestyle: 'lifestyle',
  entertainment: 'entertainment', arts: 'entertainment', movies: 'entertainment', tv: 'entertainment', music: 'entertainment',
  finance: 'finance', money: 'finance', markets: 'finance',
  auto: 'automotive', autos: 'automotive', cars: 'automotive',
